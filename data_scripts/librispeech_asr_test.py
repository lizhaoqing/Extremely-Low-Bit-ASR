...
class LibrispeechASR(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        # print('local_extracted_archive: ', type(local_extracted_archive['dev']))
        local_extracted_archive = {}
        archive_path = {}

        local_extracted_archive['dev.clean'] = local_data_path +'LibriSpeech/dev-clean/'
        local_extracted_archive['dev.other'] = local_data_path +'LibriSpeech/dev-other/'
        local_extracted_archive["test.other"] = local_data_path +'LibriSpeech/test-other/'
        local_extracted_archive["test.clean"] = local_data_path +'LibriSpeech/test-clean/'
        archive_path['dev.clean']=local_data_path + 'dev-clean.tar.gz'
        archive_path['dev.other']=local_data_path + 'dev-other.tar.gz'
        archive_path["test.other"] = local_data_path + 'test-other.tar.gz'
        archive_path['test.clean']=local_data_path + 'test-clean.tar.gz'
